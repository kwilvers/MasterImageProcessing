...
D'autre améliorations possible : 
    ...
    Utiliser Dropout(0.25) from keras.layers import Dropout après Maxpooling ou Dense
'''
...
predict_path = "C:/Users/karl/Pictures/Convolutional_Neural_Networks/Convolutional_Neural_Networks/dataset/single_prediction/cat_or_dog_3.jpg"
im = load_img(predict_path, target_size=(64, 64))
im = img_to_array(im)
im = im.reshape((1, im.shape[0], im.shape[1], im.shape[2]))
res = classifier.predict_classes(x=im)

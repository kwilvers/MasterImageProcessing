...
namespace BooleanEdgeDetection
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            cmbFilterType.Items.Add(ExtBitmap.BooleanFilterType.None);
            cmbFilterType.Items.Add(ExtBitmap.BooleanFilterType.EdgeDetect);
            cmbFilterType.Items.Add(ExtBitmap.BooleanFilterType.Sharpen);
        ...
        private void ApplyFilter(bool preview)
        {
            ...
            {
                ExtBitmap.BooleanFilterType filterType = 
                    ((ExtBitmap.BooleanFilterType)cmbFilterType.SelectedItem);

                if (filterType == ExtBitmap.BooleanFilterType.None)
                {
                    bitmapResult = selectedSource;
                }
                else
                {
                    bitmapResult = selectedSource.BooleanEdgeDetectionFilter(
                                   filterType, trcRedValue.Value / 100.0f, 

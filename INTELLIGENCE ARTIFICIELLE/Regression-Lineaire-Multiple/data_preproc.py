...
#Sx[:, [0,2]] = imputer.transform(x[:, [0,2]])  
...
#Effectue le fit et le transform simultanément en transformant les textes en nombre
...
#pour éviter le problème de multicolenarité, il faut supprimer une dummy variable
x = x[:, 1:]
...
# Construction du modele de régression linéaire multiple
...
#nouvelle prediction manuelle à New York, 130k R&D, 140k Admin, 300k Marketing
